...
**Reference file:** 
* candidature_finanziate_144.csv<br>
* candidature_finanziate_144.json<br>

Il dataset contiene la lista delle proposte di finanziamento relative alla misura "1.4.4 Adozione identità digitale" che hanno superato i controlli di ricevibilità e ammissibilità e per le quali gli enti hanno provveduto alla comunicazione del codice CUP. 
