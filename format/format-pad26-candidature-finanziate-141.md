...
**Reference file:** 
* candidature_finanziate_141.csv<br>
* candidature_finanziate_141.json<br>

Il dataset contiene la lista delle proposte di finanziamento relative alla misura "1.4.1 Esperienze del Cittadino nei Servizi Pubblici" che hanno superato i controlli di ricevibilità e ammissibilità e per le quali gli enti hanno provveduto alla comunicazione del codice CUP. 
